...
print(f"O tipo do dado da variável minha_list é: {type(minha_lista)}")
...
# válidos aqui
# primeiro_item_da_lista = minha_lista[1]
# print(f"O item da lista é: {primeiro_item_da_lista}")
#
# ultimo_item_da_list = minha_lista[-1]
# print(f"O ultimo item da lista é: {ultimo_item_da_list}")
#
...
# len(): Esta funçaão, que vale para qualquer iterable, também funciona com lists
...
# minha_tupla[0] = 100  # tentar fazer isso vai causar uma Exception
